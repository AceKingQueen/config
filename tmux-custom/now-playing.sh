...
if [ -n "$output" ]; then
  ...
  # No output from MediaRemote/playerctl.
  # We want:
  # - nothing when Spotify is closed
  # - paused icon when Spotify is open but paused
